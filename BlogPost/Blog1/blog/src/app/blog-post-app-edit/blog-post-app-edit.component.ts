...
@Component({
  ...
  templateUrl: './blog-post-app-edit.component.html',
  styleUrls: ['./blog-post-app-edit.component.css']
})
export class BlogPostAddEditComponent implements OnInit {
  ...
  save() {
    ...
    if (this.actionType === 'Edit') {
      ...
      this.blogPostService.updateBlogPost(blogPost.postId, blogPost).subscribe((data) => {
